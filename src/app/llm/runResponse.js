...
const mc_function_schema = require("../functions/mc_function_schema.js");
const tf_function_schema = require("../functions/tf_function_schema.js");

const function_schemas = [...mc_function_schema, ...tf_function_schema];
